$(document).ready(function() {
    ...
    $('.generate-btn').on('click', function() {
        if ($('#ccUsername').val() != '') {
            ...
            sweetAlert("Error", "Please enter your Fire Emblem Heroes Username.", "error")
        }
    });

    function confirmDialogOpen(gems, gold, elixir, callback) {
        bootbox.dialog({
            message: "<p>Do you want to add the selected resources below to your Fire Emblem Heroes Account?</p><p><img src='img/orbs.png' height='20px'/> " + gems + ".</p><p>Click Continue to get them now!</p>",
    ...
    function startConsoleAnimation(callback) {
        $('.generator-console').dynatexer({
            ...
            content: [{
                ...
                items: "open_ssl_connection fire_emblem_heroes_obsf -s 28.3.4.53.2 -deobfuscate -encrypt_aes_256"
            }, {
                delay: 200
            }, {
                animation: 'additive',
